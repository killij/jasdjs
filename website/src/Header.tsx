...
export default () => { 
    ...
    if (path === "/" || path === "/index") homeActive = true
    if (path === "/tryitnow") tryActive = true

    return <div className="container-fluid">
        <header className="d-flex flex-wrap justify-content-center py-3 mb-0 border-bottom">
            <Link to="/"className="d-flex align-items-center mb-3 mb-md-0 me-md-auto link-body-emphasis text-decoration-none">
                <span className="display-6 fw-bold">JASD</span>
                <span className="display-6">js</span>
            </Link>
            <ul className="nav nav-pills">
                ...
                <li className="nav-item">
                    <a href="https://github.com/killij/jasdjs" className="nav-link">
                        Github&nbsp;
